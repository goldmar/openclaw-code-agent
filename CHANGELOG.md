...
- The plan decision brief keeps a fenced code block with the step that introduces it (as inline code) instead of splitting its lines into brief fields (an `Objective / scope` field showing only the opening fence).
