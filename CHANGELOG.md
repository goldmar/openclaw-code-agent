...
- A multi-select answer that named an option whose label contains a comma (for example "Yes, continue") was split at the comma and sent as two free-text answers. Labels that contain commas or newlines now select their option.
