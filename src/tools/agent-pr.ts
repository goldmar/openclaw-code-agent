...
export function makeAgentPrTool(_ctx?: OpenClawPluginToolContext, options: { metadataProvider?: PrMetadataProvider } = {}) {
  return {
    ...
    parameters: Type.Object({
      ...
      force_new: Type.Optional(Type.Boolean({ description: "Only create a new PR: fail instead of updating when a PR already exists for the branch; a closed PR recorded for the session is ignored (default: false)" })),
