...
describe("session-notification-builder", () => {
  ...
  it("builds plugin-owned plan review summaries from structured artifacts", () => {
  ...
  it("instructs delegated plan reviews to use structured approval rationale plus orchestrator-owned explanation", () => {
    const payload = buildWaitingForInputPayload({
      session: {
        id: "session-delegate",
